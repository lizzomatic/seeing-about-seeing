      ...
      <main className='bg-white'>
        <div className='grid'>
          ...
          {/* <Image src="/images/urbanFreeway.jpeg" className='' width="600" height="600"
            alt="chaotic urban scene with a long freeway to the sky" /> */}
        </div>
        {/* <Carousel responsive={responsive}>
          <div>
            <img src="/images/iDontKnowNorKnowWhoKnows.jpg" width="600" height="600"
              alt="I don't know nor know who knows" />
          </div>
          <div>
            <img src="/images/abstractStripes.png" width="600" height="600"
              alt='abstract stripes' />
          </div>
          <div>Item 4</div>
        </Carousel> */}
